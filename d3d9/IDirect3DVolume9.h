...
struct IDirect3DVolume9 : public IUnknown
{
    ...
    IFACEMETHOD(SetPrivateData)(REFGUID guid, _In_reads_(size) const void* data, DWORD size, DWORD dlags) = 0;
    ...
    IFACEMETHOD(LockBox)(_In_ D3DLOCKED_BOX* locked_volume, _In_opt_ const D3DBOX* box, DWORD flags) = 0;
